        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Perbarui Informasi Lowongan Kerja</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('news.update', ['id' => $dataLoker->id]) }}" method="POST"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name='nama_perusahaan'
                                        value="{{ $dataLoker->nama_perusahaan }}" required>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control datemask  datepicker"
                                            name='tanggal_pembukaan' value="{{ $dataLoker->tanggal_pembukaan }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control datemask  datepicker"
                                            name='tanggal_penutupan' value="{{ $dataLoker->tanggal_penutupan }}">
                                    </div>
                                </div>
                            </div>
                        </div>
